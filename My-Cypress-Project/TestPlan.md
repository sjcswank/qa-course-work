# Test Plan
- **Written By:** Heather Frank (sjcswank)
- **Date:** 08/29/2025
- **Project:** QA Course Work

## Introduction
**Overview:** Test plan for User Auth app   
**Scope:** User creation, login, and log out, Accessibility  
**Objectives:** Identify and report defects, verify secure user creation and login, verify Web Content Accessibility Guidelines Level AA standard compliance  
...
## Sucess Criteria
1. No critical/high severity bugs in Prod
2. 95% test case pass rate