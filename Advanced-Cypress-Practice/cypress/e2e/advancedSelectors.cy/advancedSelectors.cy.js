describe("Tests to practice advanced Selectors and Page Interactions", () => {
  ...
  it("should display and confirm the JS Confirm alert", () => {
    ...
    cy.contains("button", "Click for JS Confirm")
      .click()
      .then(() => {
  ...
  // DONE: Practice automating drag-and-drop interactions.
  ...
  it("should drag an element to a target area", () => {
  ...
  // DONE: Test the visibility and functionality of a floating menu.
  ...
  it("should show and navigate the floating menu", () => {
